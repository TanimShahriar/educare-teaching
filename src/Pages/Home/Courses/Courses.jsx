...
const Courses = () => {
  ...
  return (
    <div className="pt-20 bg-black bg-opacity-95 text-white">
      <Helmet>
        <title>Educare | Courses</title>
      </Helmet>
      <h2 className="ml-5  text-center text-3xl font-semibold ">All Courses</h2>
      <div className="grid lg:grid-cols-3 gap-2 px-1 mt-5">
        {
          courses.map(data => <div key={data._id} className="  shadow-lg shadow-black p-4 rounded-lg ">
            ...
            <div className="space-y-4">
              ...
              <div>
                <button data-aos="zoom-in" className="px-2 lg:px-5 py-1 lg:py-2 bg-lime-600 text-white cursor-pointer">Details</button>
              </div>
            </div>
          </div>)
        }
