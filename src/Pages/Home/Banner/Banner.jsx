...
const Banner = () => {
  ...
  return (
    ...
    <div className="hero border-red-600 h-full lg:h-[80vh]" style={{ backgroundImage: 'url(https://i.ibb.co/BZWRphk/17631650-Goi-July6.jpg)' }}>
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-2xl ">
          ...
          <Link to="/gallery"> <button data-aos="zoom-in" className="px-2 lg:px-5 py-1 lg:py-2 bg-lime-600 text-white cursor-pointer">Explore</button></Link>
        </div>
      </div>
    </div>
